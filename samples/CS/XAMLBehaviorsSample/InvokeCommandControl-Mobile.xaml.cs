...
{
    public sealed partial class InvokeCommandControl_Mobile : UserControl, INotifyPropertyChanged
    {
        ...
        public class SampleCommand_Mobile : ICommand
        {
        ...
        public InvokeCommandControl_Mobile()
        {
            this.InitializeComponent();
            UpdateCountCommand = new SampleCommand_Mobile();
            UpdateGreyCommand = new SampleCommand_Mobile();
            UpdatePinkCommand = new SampleCommand_Mobile();
