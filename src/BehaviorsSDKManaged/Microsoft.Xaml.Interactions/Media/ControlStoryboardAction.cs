...
namespace Microsoft.Xaml.Interactions.Media
{
    ...
    public sealed class ControlStoryboardAction : DependencyObject, IAction
    {
        ...
        public static readonly DependencyProperty IsPausedProperty = DependencyProperty.RegisterAttached("IsPaused", typeof(bool), typeof(ControlStoryboardAction), new PropertyMetadata(false));

        public static void SetIsPaused(Storyboard obj, bool value)
        {
            obj.SetValue(IsPausedProperty, value);
        }

        public static bool GetIsPaused(Storyboard obj)
        {
                ...
                case ControlStoryboardOption.TogglePlayPause:
                    {
                        ...
                        {
                            SetIsPaused(this.Storyboard, false);
                            this.Storyboard.Begin();
                        }
                        else if (GetIsPaused(this.Storyboard))
                        {
                            SetIsPaused(this.Storyboard, false);
                        ...
                        {
                            SetIsPaused(this.Storyboard, true);
