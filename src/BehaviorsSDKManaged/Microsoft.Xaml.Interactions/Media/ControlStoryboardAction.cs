...
namespace Microsoft.Xaml.Interactions.Media
{
    ...
    public sealed class ControlStoryboardAction : DependencyObject, IAction
    {
        ...
        public static readonly DependencyProperty IsPausedProperty = DependencyProperty.RegisterAttached("IsPaused", typeof(bool), typeof(Storyboard), new PropertyMetadata(false));
